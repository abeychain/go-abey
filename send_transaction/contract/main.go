...
func deployContractsInBatch(rpcClient *rpc.Client, client *abeyclient.Client, privKeys []*ecdsa.PrivateKey) []common.Address {
...
func rechargeToAccountsByContract(rpcClient *rpc.Client, client *abeyclient.Client, privKeys []*ecdsa.PrivateKey,
