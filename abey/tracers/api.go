...
type TraceCallConfig struct {
	*vm.LogConfig
	...
	Timeout        *string
	Reexec         *uint64
	StateOverrides *abeyapi.StateOverride
}
...
func (api *API) TraceCall(ctx context.Context, args abeyapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
