...
func (fp *StateProcessor) Process2(block *types.Block, statedb *state.StateDB,cfg vm.Config) (types.Receipts, []*types.Log, uint64, *types.ChainReward, error) {
	return fp.Process(block,statedb,cfg)
	//var (
	//	receipts  types.Receipts
	//	usedGas   = uint64(0)
	//	feeAmount = big.NewInt(0)
